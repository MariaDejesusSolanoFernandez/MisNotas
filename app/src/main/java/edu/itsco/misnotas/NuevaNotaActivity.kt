...
class NuevaNotaActivity : AppCompatActivity(), View.OnClickListener  {
    ...
    private lateinit var txtDescripion: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtDescripion = findViewById(R.id.txt_descripcion)
    ...
    override fun onClick(v: View?) {
        ...
        if (TextUtils.isEmpty(txtTitulo.text)&&TextUtils.isEmpty(txtDescripion.text)){
            setResult(Activity.RESULT_CANCELED, intent)


        } else {
            val nota = Nota(titulo = txtTitulo.text.toString(),
                descripcion = txtDescripion.text.toString())
